...
const baseConfig = new ScratchWebpackConfigBuilder(
    ...
    .addPlugin(new webpack.DefinePlugin({
        ...
        // ACCESS_CODE (Fase 2) sacado acá — Fase 6: hallazgo de la auditoría de seguridad, ese
        // valor fijo (con fallback hardcodeado) quedaba de conocimiento público en este repo
        // (AGPL). Reemplazado por un código rotativo validado contra la API, ver
        // access-gate.jsx/editor-access-code-session.js.
    }))
